...
function setup(){
    ...
    angleMode(DEGREES);
    angle = prompt('Enter Rotation Factor in Degree:');
    axis = prompt('Enter Rotation Axis: X or Y or Z:');
}
...
function draw(){
    ...
    let rotationMatrix = getRotationMatrix(axis, angle);
      
    a1 = mat_multi(rotationMatrix,a);
    b1 = mat_multi(rotationMatrix,b);
    c1 = mat_multi(rotationMatrix,c);
    d1 = mat_multi(rotationMatrix,d);
    e1 = mat_multi(rotationMatrix,e);
    f1 = mat_multi(rotationMatrix,f);
    g1 = mat_multi(rotationMatrix,g);
    h1 = mat_multi(rotationMatrix,h);
